...
os.environ.setdefault("AZURE_STORAGE_ACCOUNT_NAME", "fake-storage")
os.environ.setdefault("AZURE_STORAGE_ACCOUNT_KEY", "ZmFrZWtleWZha2VrZXlmYWtla2V5ZmFrZWtleWZha2VrZXlmYWtla2V5ZmFrZWtleWZha2VrZXlmYWtla2V5Zg==")
