...
def docker_container():
    ...
    run = subprocess.run(
        [
            ...
            "-e", "AZURE_STORAGE_ACCOUNT_NAME=fake-storage",
            "-e", "AZURE_STORAGE_ACCOUNT_KEY=ZmFrZWtleWZha2VrZXlmYWtla2V5ZmFrZWtleWZha2VrZXlmYWtla2V5ZmFrZWtleWZha2VrZXlmYWtla2V5Zg==",
            "-e", "AZURE_STORAGE_CONTAINER=uploads",
            IMAGE_TAG,
        ],
        capture_output=True,
        text=True,
